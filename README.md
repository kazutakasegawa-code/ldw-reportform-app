# 『採用・定着・育成』の「課題見える化」5分診断

Life Design Worksの「『採用・定着・育成』の『課題見える化』5分診断」をWebアプリ化したMVPです。企業の魅力が学生や若手に伝わっているか、入社後に定着・成長できる環境があるか、社員が主体的に行動し、チームで成果を出せる状態かを確認します。公開フォーム、診断結果ページ、レーダーチャート、30分面談＋AI詳細診断CTA、管理画面、AI分析補助、A4レポートのブラウザ印刷PDF出力に対応しています。
...
AI分析には、会社名・担当者名・メールアドレス・電話番号を使用しません。業種・従業員規模などの組織情報、診断回答、管理者が入力した分析用情報を使用します。自由記述に対象情報と同じ値が含まれる場合も、AI分析用プロンプト生成時に伏せ字へ置き換えます。
