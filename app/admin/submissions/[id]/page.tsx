      ...
      <Container className="py-8">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href={`/diagnosis/result/${submission.resultToken}`} className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-navy-800 bg-white px-5 py-2.5 text-sm font-semibold text-navy-900 hover:bg-slate-50">
              <BarChart3 size={18} />
              診断済み画面
            </Link>
